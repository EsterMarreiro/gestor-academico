...
const TCP_DOWN_HINT =
  ...
  '4002, `npm run start:matriculas-ms:dev` na 4005, `npm run start:alunos-ms:dev` na 4007, `npm run start:professores-ms:dev` na 4008, `npm run start:alunos-turma-ms:dev` na 4009 e `npm run start:inscricoes-professor-ms:dev` na 4010). Com Docker, confirme o contentor do MS e variáveis *_MS_HOST.';
