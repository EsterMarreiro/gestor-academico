...
const TCP_DOWN_HINT =
  ...
  '(gateway + todos os microserviços) ou o script do serviço em falta (ex.: `npm run start:matriculas-ms:dev` ' +
  'para matrículas na porta por defeito 4005). Com Docker, confirme o contentor do MS e variáveis *_MS_HOST.';
